...
const baseUrl = 'https://wathiqnote-approved-source-q1bib96s3-23bhuzko0-wathiqcare.vercel.app';
const outDir = path.resolve(process.cwd(), 'screenshots/entry-points');

const routes = [
  { name: 'deployed-preview-en', path: '/preview/white-landing/en', waitFor: 4000 },
  { name: 'deployed-preview-ar', path: '/preview/white-landing/ar', waitFor: 4000 },
  { name: 'deployed-preview-homepage', path: '/', waitFor: 4000 },
];
