...
const baseUrl = 'https://wathiqcare-white-landing-preview-ct0mxc85g-wathiqcare.vercel.app';
const outDir = path.resolve(process.cwd(), 'screenshots/entry-points');

const routes = [
  { name: 'public-preview-en', path: '/preview/white-landing/en', waitFor: 5000 },
  { name: 'public-preview-ar', path: '/preview/white-landing/ar', waitFor: 5000 },
  { name: 'public-preview-homepage', path: '/', waitFor: 5000 },
];
