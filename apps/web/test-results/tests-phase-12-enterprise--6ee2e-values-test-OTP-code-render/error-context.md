...
- Name: tests\phase-12-enterprise-consent.spec.ts >> Phase 12.2 — Enterprise Informed Consent Integration >> TEST MODE banner + default patient values + test OTP code render
- Location: tests\phase-12-enterprise-consent.spec.ts:138:7
