...
const queue = [
  { id: "AQ-001", patientEn: "Omar Al-Rashid", patientAr: "عمر الراشد", mrn: "MRN-187432", procedureEn: "Cardiac Catheterization", procedureAr: "قسطرة قلبية", typeEn: "General Anesthesia", typeAr: "تخدير عام", orRoom: "OR-1", scheduledTime: "08:00", anesthesiologistEn: "Dr. Sara Al-Mansouri", anesthesiologistAr: "د. سارة المنصوري", status: "pending" as const, alert: true, alertMsgEn: "Allergy: Penicillin", alertMsgAr: "حساسية: بنسلين" },
  { id: "AQ-002", patientEn: "Fatimah Ibrahim", patientAr: "فاطمة إبراهيم", mrn: "MRN-210045", procedureEn: "Cataract Surgery", procedureAr: "جراحة الساد", typeEn: "Local Anesthesia", typeAr: "تخدير موضعي", orRoom: "OR-3", scheduledTime: "09:30", anesthesiologistEn: "Dr. Yusuf Al-Harbi", anesthesiologistAr: "د. يوسف الحربي", status: "approved" as const, alert: false, alertMsgEn: "", alertMsgAr: "" },
  { id: "AQ-003", patientEn: "Khalid Nasser", patientAr: "خالد ناصر", mrn: "MRN-195700", procedureEn: "Knee Replacement", procedureAr: "تبديل مفصل الركبة", typeEn: "Spinal Epidural", typeAr: "تخدير نخاعي", orRoom: "OR-2", scheduledTime: "11:00", anesthesiologistEn: "Dr. Sara Al-Mansouri", anesthesiologistAr: "د. سارة المنصوري", status: "anesthesia" as const, alert: true, alertMsgEn: "Diabetes Type 2 — check glucose", alertMsgAr: "سكري نوع ٢ — تحقق من الجلوكوز" },
  { id: "AQ-004", patientEn: "Reem Al-Zahrani", patientAr: "ريم الزهراني", mrn: "MRN-199832", procedureEn: "Hernia Repair", procedureAr: "إصلاح الفتق", typeEn: "General Anesthesia", typeAr: "تخدير عام", orRoom: "OR-1", scheduledTime: "13:00", anesthesiologistEn: "Dr. Yusuf Al-Harbi", anesthesiologistAr: "د. يوسف الحربي", status: "pending" as const, alert: false, alertMsgEn: "", alertMsgAr: "" },
];
        ...
        <div className="px-6 py-5 border-b bg-white" style={{ borderColor: "#D8E8EF" }}>
          <div className="flex items-center justify-between mb-1">
            <h2 className="text-xl font-bold" style={{ color: "#102A43" }}>
              {isRTL ? "قائمة انتظار التخدير" : "Anesthesia Queue"}
            </h2>
          ...
          <p className="text-sm" style={{ color: "#64798B" }}>
            {isRTL ? "الثلاثاء ٩ يونيو ٢٠٢٦ · مستشفى الملك عبدالعزيز" : "Tuesday June 9, 2026 · King Abdulaziz Hospital"}
          </p>
        </div>
      ...
      {sel && (
        <div className="w-80 border-l bg-white overflow-y-auto flex-shrink-0" style={{ borderColor: "#D8E8EF" }}>
          <div className="px-5 py-4 border-b flex items-center justify-between" style={{ borderColor: "#D8E8EF" }}>
            <span className="text-sm font-bold" style={{ color: "#102A43" }}>{isRTL ? "تفاصيل التخدير" : "Anesthesia Detail"}</span>
          ...
          <div className="p-5 space-y-4">
            ...
            <div className="space-y-2">
              {[
                ...
                { labelEn: "Anesthesia Type", labelAr: "نوع التخدير", val: isRTL ? sel.typeAr : sel.typeEn },
                { labelEn: "OR Room", labelAr: "غرفة العمليات", val: sel.orRoom },
                { labelEn: "Scheduled", labelAr: "الموعد", val: sel.scheduledTime },
                { labelEn: "Anesthesiologist", labelAr: "طبيب التخدير", val: isRTL ? sel.anesthesiologistAr : sel.anesthesiologistEn },
              ].map(row => (
            ...
            <div className="flex gap-2">
              ...
              <button className="flex-1 py-2.5 rounded-xl text-sm font-semibold border flex items-center justify-center gap-1.5" style={{ borderColor: "#D8E8EF", color: "#64798B" }}>
                <Clock size={14} /> {isRTL ? "تأجيل" : "Defer"}
              </button>
            </div>
          </div>
        </div>
