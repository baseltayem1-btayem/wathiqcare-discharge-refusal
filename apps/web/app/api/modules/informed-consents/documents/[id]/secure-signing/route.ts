    ...
    if (!alreadyCompleted) {
      ...
      await recordPatientEducationEvent({
        ...
        extra: {
          ...
          visualAidDisplayed: false,
          visualAidTypeEn: "AI-assisted 3D Anatomy / Clinical Illustration",
          visualAidTypeAr: "نموذج تشريحي ثلاثي الأبعاد / رسم سريري مدعوم بالذكاء الاصطناعي",
          ...
          patientAcknowledgementStatus: "Education opened",
      ...
      await recordPatientEducationEvent({
        ...
        extra: {
          ...
          visualAidPurposeEn: "Patient education only; not diagnostic interpretation",
          visualAidPurposeAr: "للتثقيف فقط؛ وليس للتشخيص أو تفسير الصور الطبية",
          patientAcknowledgementStatus: "Understanding passed",
          passed: true,
          patientAcknowledged: true,
        },
        request,
      ...
      await recordPatientEducationEvent({
        ...
        extra: {
          ...
          visualAidPurposeEn: "Patient education only; not diagnostic interpretation",
          visualAidPurposeAr: "للتثقيف فقط؛ وليس للتشخيص أو تفسير الصور الطبية",
          patientAcknowledgementStatus: "Education completed",
          patientAcknowledged: true,
        },
        request,
      });
