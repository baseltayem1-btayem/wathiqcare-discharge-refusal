...
import { PhysicianWorkflow } from './components/PhysicianWorkflow';
import type { Patient, Encounter } from './components/clinical/ClinicalTypes';

type Screen = 'dashboard' | 'search' | 'consent-builder' | 'workflow' | 'status';

const navItems = [
  { id: 'dashboard' as Screen, label: 'Dashboard', labelAr: 'لوحة التحكم', icon: LayoutDashboard },
  { id: 'workflow' as Screen, label: 'Physician Workflow', labelAr: 'سير عمل الطبيب', icon: FileText },
  { id: 'search' as Screen, label: 'Patient Search', labelAr: 'البحث عن مريض', icon: Search },
  { id: 'consent-builder' as Screen, label: 'Consent Builder (Old)', labelAr: 'بناء الموافقة (قديم)', icon: FileText },
