  ...
  return (
    <span
      className={cn(
        ...
        size === "default" &&
          "px-1.5 py-0.5 text-[11px] font-bold uppercase tracking-[0.03em] rounded-full",
        size === "sm" && "px-1.5 py-0.5 text-[10px] font-semibold rounded-full",
        size === "lg" &&
          "px-3 py-2 text-[0.75rem] font-semibold tracking-[0.04em] rounded-full",
        variant === "default" &&
        ...
        variant === "destructive" &&
          "border-[var(--state-error-border)] bg-[var(--state-error-bg)] text-[var(--state-error)]",
        variant === "info" &&
          "border-[var(--state-info-border)] bg-[var(--state-info-bg)] text-[var(--state-info)]",
