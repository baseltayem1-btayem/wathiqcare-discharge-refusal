/**
 * Generate a human-friendly production checklist for FigureLabs Batch 3.
 *
 * Usage:
 *   npx tsx scripts/generate-figurelabs-batch-03-checklist.ts
 *
 * Outputs:
 *   docs/clinical-illustrations/batches/figurelabs_batch_03_production_checklist.md
 */

import { writeFileSync, readFileSync } from "node:fs";

const BATCH_CSV = "../../docs/clinical-illustrations/batches/figurelabs_batch_03_priority_20.csv";
const OUTPUT_MD = "../../docs/clinical-illustrations/batches/figurelabs_batch_03_production_checklist.md";
...
function main() {
  ...
  sections.push(`# FigureLabs Batch 3 Production Checklist`);
  sections.push("");
  ...
  console.log(`Wrote Batch 3 production checklist to ${OUTPUT_MD}`);
}
