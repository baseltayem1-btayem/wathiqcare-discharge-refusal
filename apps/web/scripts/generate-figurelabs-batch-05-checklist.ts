/**
 * Generate a human-friendly production checklist for FigureLabs Batch 5.
 *
 * Usage:
 *   npx tsx scripts/generate-figurelabs-batch-03-checklist.ts
 *
 * Outputs:
 *   docs/clinical-illustrations/batches/figurelabs_batch_05_production_checklist.md
 */

import { writeFileSync, readFileSync } from "node:fs";

const BATCH_CSV = "../../docs/clinical-illustrations/batches/figurelabs_batch_05_priority_20.csv";
const OUTPUT_MD = "../../docs/clinical-illustrations/batches/figurelabs_batch_05_production_checklist.md";
...
function main() {
  ...
  sections.push(`# FigureLabs Batch 5 Production Checklist`);
  sections.push("");
  ...
  console.log(`Wrote Batch 5 production checklist to ${OUTPUT_MD}`);
}
