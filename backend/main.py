...
from backend.api.routers.discharge_refusal_workflow import (
    router as discharge_refusal_workflow_router,
)
...
from backend.api.routers.shc_discharge_compliance import (
    router as shc_discharge_compliance_router,
)
