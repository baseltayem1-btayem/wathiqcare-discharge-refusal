...
import { runRefusalEngine } from "@/lib/server/platform/refusal-engine";
...
export async function POST(request: NextRequest) {
  try {
    ...
    const generated = await runRefusalEngine({
    ...
    return NextResponse.json({ ok: true, module: "refusal_engine", ...generated });
  } catch (error) {
