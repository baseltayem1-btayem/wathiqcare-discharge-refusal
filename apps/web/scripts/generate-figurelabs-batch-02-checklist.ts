/**
 * Generate a human-friendly production checklist for FigureLabs Batch 2.
 *
 * Usage:
 *   npx tsx scripts/generate-figurelabs-batch-02-checklist.ts
 *
 * Outputs:
 *   docs/clinical-illustrations/batches/figurelabs_batch_02_production_checklist.md
 */

import { writeFileSync, readFileSync } from "node:fs";

const BATCH_CSV = "../../docs/clinical-illustrations/batches/figurelabs_batch_02_priority_20.csv";
const OUTPUT_MD = "../../docs/clinical-illustrations/batches/figurelabs_batch_02_production_checklist.md";
...
function main() {
  ...
  sections.push(`# FigureLabs Batch 2 Production Checklist`);
  sections.push("");
  ...
  console.log(`Wrote Batch 2 production checklist to ${OUTPUT_MD}`);
}
