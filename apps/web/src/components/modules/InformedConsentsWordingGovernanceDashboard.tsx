  ...
  return (
    ...
    >
      <div className="space-y-4">
        {loading ? <div className="rounded-lg border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-600">{locale === "ar" ? "جاري تحميل حوكمة النصوص..." : "Loading wording governance..."}</div> : null}
